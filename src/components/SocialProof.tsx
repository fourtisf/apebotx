            ...
            <div className="w-full max-w-3xl">
              <Marquee durationSec={32}>
                {STACK.map((s) => (
                  <span
                    key={s}
                    className="mx-2 inline-flex items-center gap-2 rounded-full border border-[var(--border)] bg-[var(--surface)]/60 px-4 py-1.5 font-mono text-xs uppercase tracking-[0.12em] text-text-muted"
                  >
