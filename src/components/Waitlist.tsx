      ...
      <div className="container-content">
        <Reveal>
          <div className="gradient-border">
            <div className="glass-strong relative overflow-hidden rounded-2xl px-6 py-12 sm:px-12 sm:py-16">
              <div
                aria-hidden
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle, color-mix(in srgb, var(--accent-2) 22%, transparent), transparent 65%)",
                }}
              />
