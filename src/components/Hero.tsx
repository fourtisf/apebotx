...
export function Hero() {
  ...
  const stats = [h.stats.segments, h.stats.channels, h.stats.languages];
        ...
        <Spotlight size={520}>
          <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
            ...
            <div>
              ...
              <Reveal delay={0.06}>
                <h1 className="mt-6 text-balance text-[2.6rem] font-semibold leading-[1.02] tracking-[-0.03em] sm:text-6xl lg:text-[4.25rem]">
                  <span className="headline-sheen">Automate the </span>
                  <span className="text-brand-gradient bg-[length:200%_auto] animate-text-pan">
                    smartest money
                  </span>
                  <span className="headline-sheen"> on Solana.</span>
                </h1>
              </Reveal>
            ...
            {/* Dual-channel bot showcase */}
            <Reveal delay={0.2}>
              <div className="relative">
                <div
                  aria-hidden
                  className="pointer-events-none absolute -inset-8 -z-0 rounded-[2.5rem] opacity-70 blur-3xl"
                  style={{
                    background:
                      "radial-gradient(50% 50% at 60% 25%, color-mix(in srgb, var(--accent) 16%, transparent), transparent 70%), radial-gradient(50% 50% at 25% 85%, color-mix(in srgb, var(--accent-2) 18%, transparent), transparent 70%)",
                  }}
                />
                <div className="relative">
                  <BotShowcase />
