...
export const id: LocaleDict = {
  ...
  hero: {
    ...
    sub: "Ocolos menilai dompet on-chain yang untung dan mengirim sinyal begitu mereka masuk — tersegmentasi, anti-rug, dan dikirim langsung ke Telegram dan X dalam bahasa Anda.",
