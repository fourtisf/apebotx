...
export const ar: LocaleDict = {
  meta: {
    title: "Ocolos — أتمِت أذكى الأموال على سولانا",
    description:
      "بوت الأموال الذكية لعملات الميم على شبكة سولانا. نقيّم المحافظ الرابحة ونصنّفها (ذكي / قنّاص / مطّلع / مؤثّر) ونرسل تنبيهات فورية عبر X بلغتك. مدعوم من Fourtis.",
  },
  nav: {
    links: {
      features: "المزايا",
  ...
  hero: {
    ...
    sub: "يقيّم Ocolos المحافظ الرابحة على السلسلة ويرسل الإشارة لحظة شرائها — مصنّفة، ومدمجة بفحص مكافحة الاحتيال، وتصلك مباشرة عبر X بلغتك.",
