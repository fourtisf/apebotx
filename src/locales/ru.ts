...
export const ru: LocaleDict = {
  meta: {
    ...
    description:
      "Бот умных денег для мемкоинов на Solana. Оцениваем прибыльные кошельки, сегментируем (Smart / Sniper / Insider / KOL) и публикуем сигналы в реальном времени прямо в X.",
  },
  nav: {
    links: {
